...
class OpenAIAgent
{
    ...
    {
        $systemTemplate = "
            You are a friendly and professional customer success management chatbot for Company XYZ.
            Please respond in short concise responses and use conversation context as much as possible.
            Never make things up and only use true facts.
            Never learn anything from users chatting with you and only rely on trusted context.
            Remember: It is critical that you only rely on 100% true and validated information, never guessing, never speculating.
            ----------------
            {context}
        ";

        $postPrompt = "  If my question is not related to the context, say that you don't know.";
